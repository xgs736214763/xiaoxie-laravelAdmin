                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding">
                        <table  id="example2" class="table table-bordered table-hover">
                            <tbody><tr>
                                <td>操作系统：<?php echo e($server['os']); ?></td>
                            </tr>
                            <tr>
                                <td>PHP版本：<?php echo e($server['version']); ?></td>
                            </tr>
                            <tr>
                                <td>运行环境：<?php echo e($server['server']); ?></td>
                            </tr>
                            <tr>
                                <td>最大上传限制：<?php echo e($server['upload']); ?></td>
                            </tr>
                            <tr>
                                <td>最大执行时间：<?php echo e($server['time']); ?></td>
                            </tr>
                            <tr>
                                <td>MySQL最大连接数：<?php echo e($server['limit']); ?></td>
                            </tr>
                            <tr>
                                <td>脚本运行占用最大内存：<?php echo e($server['memory_limit']); ?></td>
                            </tr>
                            <tr>
                                <td>服务器时间：<?php echo e($server['date']); ?></td>
                            </tr>
                            </tbody></table>
                    </div>
                </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php if(!empty($logs)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="label label-primary"><?php echo e($log->ip); ?></span></td>
                                    <td> <?php echo e($log->city); ?>  </td>
                                    <td><?php echo e($log->created_at); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td colspan="3"><?php echo e($logs->links()); ?></td>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="POST" action="<?php echo e(url('admin/index/message')); ?>" >
