...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo e(asset('/static/plugins/iCheck/square/blue.css')); ?>">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo e(url('/login/checklogin')); ?>" method="post">
...
<!-- iCheck -->
<script src="<?php echo e(asset('/static/plugins/iCheck/icheck.min.js')); ?>"></script>
<script>
  $(function () {
    $('input').iCheck({
